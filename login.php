        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form accept-charset="UTF-8" role="form" method="post">
              ...
              <button class="btn btn-lg btn-block btn-primary"  name="login">Login</button>
         ...
         {
          $ambil = $koneksi->query("SELECT * FROM member WHERE username='$_POST[user]' AND password='$_POST[password]'");
          ...
          ?>
                   ...
                   <!--  <input class="btn btn-lg btn-facebook btn-block" type="submit" value="Login Admin">
                     -->
          </div>
      </div>
    </div>
